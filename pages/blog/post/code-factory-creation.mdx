...
It still has few issues.
Like I won't be able to move full belt to the right (but I can do to the left).
But this is generally har problem and without computing and solcing some kind of dependency graph I won't be able to fix this issue.
It wouldn't be that big problem if I chose physics base incremental moving.
